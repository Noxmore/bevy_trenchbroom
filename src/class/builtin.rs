	...
	const CLASS_INFO: QuakeClassInfo = QuakeClassInfo {
		...
		properties: &[
			...
			QuakeClassProperty {
				...
				default_value: Some(|| PointLight::default().range.fgd_to_string_quoted()),
			},
			QuakeClassProperty {
				ty: f32::PROPERTY_TYPE,
				name: "radius",
				...
				default_value: Some(|| PointLight::default().radius.fgd_to_string_quoted()),
			},
			QuakeClassProperty {
				...
				description: None,
				default_value: Some(|| PointLight::default().shadows_enabled.fgd_to_string_quoted()),
			},
			...
			QuakeClassProperty {
				...
				default_value: Some(|| PointLight::DEFAULT_SHADOW_NORMAL_BIAS.fgd_to_string_quoted()),
			},
			QuakeClassProperty {
				ty: f32::PROPERTY_TYPE,
				...
				default_value: Some(|| PointLight::DEFAULT_SHADOW_MAP_NEAR_Z.fgd_to_string_quoted()),
			},
		],
	};
	...
	const CLASS_INFO: QuakeClassInfo = QuakeClassInfo {
		...
		properties: &[
			...
			QuakeClassProperty {
				...
				default_value: Some(|| SpotLight::default().range.fgd_to_string_quoted()),
			},
			QuakeClassProperty {
				ty: f32::PROPERTY_TYPE,
				name: "radius",
				title: Some("Light Radius"),
				description: Some("Simulates a light source coming from a spherical volume with the given radius."),
				default_value: Some(|| SpotLight::default().radius.fgd_to_string_quoted()),
			},
			QuakeClassProperty {
				ty: bool::PROPERTY_TYPE,
				name: "shadows_enabled",
				title: Some("Enable Shadows"),
				description: None,
				default_value: Some(|| SpotLight::default().shadows_enabled.fgd_to_string_quoted()),
			},
			// Soft shadows can't be included because it's locked behind a feature
			QuakeClassProperty {
				ty: f32::PROPERTY_TYPE,
				...
				default_value: Some(|| SpotLight::DEFAULT_SHADOW_DEPTH_BIAS.fgd_to_string_quoted()),
			},
			QuakeClassProperty {
				ty: f32::PROPERTY_TYPE,
				name: "shadow_normal_bias",
				title: Some("Shadow Normal Bias"),
				description: Some("A bias applied along the direction of the fragment's surface normal. It is scaled to the shadow map's texel size so that it can be small close to the camera and gets larger further away."),
				default_value: Some(|| SpotLight::DEFAULT_SHADOW_NORMAL_BIAS.fgd_to_string_quoted()),
			},
			QuakeClassProperty {
				ty: f32::PROPERTY_TYPE,
				name: "shadow_map_near_z",
				title: Some("Shadow Map Near Z"),
				description: Some("The distance from the light to near Z plane in the shadow map."),
				default_value: Some(|| SpotLight::DEFAULT_SHADOW_MAP_NEAR_Z.fgd_to_string_quoted()),
			},
	...
	const CLASS_INFO: QuakeClassInfo = QuakeClassInfo {
		...
		properties: &[
			...
			QuakeClassProperty {
				...
				default_value: Some(|| light_consts::lux::AMBIENT_DAYLIGHT.fgd_to_string_quoted()),
			},
			QuakeClassProperty {
				ty: bool::PROPERTY_TYPE,
				name: "shadows_enabled",
				title: Some("Enable Shadows"),
				description: None,
				default_value: Some(|| DirectionalLight::default().shadows_enabled.fgd_to_string_quoted()),
			},
			// Soft shadows can't be included because it's locked behind a feature
			QuakeClassProperty {
				ty: f32::PROPERTY_TYPE,
				...
				title: Some("Shadow Depth Bias"),
				description: Some("A value that adjusts the tradeoff between self-shadowing artifacts and proximity of shadows to their casters. This value frequently must be tuned to the specific scene; this is normal and a well-known part of the shadow mapping workflow."),
				default_value: Some(|| DirectionalLight::DEFAULT_SHADOW_DEPTH_BIAS.fgd_to_string_quoted()),
			},
			QuakeClassProperty {
				ty: f32::PROPERTY_TYPE,
				name: "shadow_normal_bias",
				...
				default_value: Some(|| DirectionalLight::DEFAULT_SHADOW_NORMAL_BIAS.fgd_to_string_quoted()),
			},
		],
	};
